<?php
	include_once "links.php";
  	...
  	$title = "Læs mere om hvordan vi bruger cookies - Let Vikar";
	$canonical = "https://letvikar.dk/cookies-politik";
	$description = "Her kan du læse mere om hvordan vi anvender cookies, for at tilbyde en bedre oplevelse til vores brugere";
...
<div class="page-banner">
	<picture>
    	<source media="(min-width: 768px)" srcset="assets/img/cookies/banner_1900_400.webp">
    	<img src="assets/img/cookies/banner_360_316.webp" alt="Https tekst billede">
  	</picture>
	<div class="container">
		<div class="row">
			<div class="page-banner-content col-lg-12">
				<h1>Cookiepolitik</h1>
				<ul>
					<li><a href="<?php echo $index_link; ?>">Home</a><i class="fas fa-chevron-right"></i></li>
					<li>Cookiepolitik</li>
				</ul>
			</div>
		</div>
...
<section class="page-section cookies-policy-section wow fadeInUp" data-wow-delay="0.4s">
	<h2>Cookie- og privatlivspolitik hos LETVIKAR ApS</h2>
